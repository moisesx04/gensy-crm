      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
        <div className="card">
          ...
          <div style={{ padding: 24 }}>
            ...
            <button className="btn btn-primary" style={{ width: '100%', background: '#ef4444' }} onClick={handleLogout}>
        ...
        <div className="card">
          <div className="card-head">
            <h3><Database size={16} /> Base de Datos</h3>
          </div>
          <div style={{ padding: 24 }}>
            <p style={{ fontSize: 13, color: 'var(--t2)', marginBottom: 20 }}>El sistema está sincronizado con Vercel Postgres (Neon Cloud).</p>
            <div style={{ 
